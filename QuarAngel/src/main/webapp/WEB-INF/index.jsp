		...
		<div class="w3-bar w3-white w3-card w3-text-deep-purple" id="myNavbar">
			...
			<div class="w3-right w3-hide-small">
				<button
					...
					class="w3-bar-item w3-button">REGISTER</button>
					...
					<div class="w3-modal-content w3-card-4 w3-animate-zoom"
						...
						<div class="w3-center">
							<br /> <span
								...
								title="Close Modal">x</span> <img
								src="img/profilePicDefault.png" alt="Avatar" style="width: 30%"
						...
						<form class="w3-container" action="registration.do" method="POST">
							<div class="w3-section">
								<label><b>Username</b></label> <input class="w3-input w3-border"
									...
									placeholder="Enter Password" name="password" required /> <label><b>Email</b></label>
								<input class="w3-input w3-border" type="text"
									placeholder="Enter Email" name="email" required /> <label><b>First
										Name</b></label> <input class="w3-input w3-border" type="text"
									placeholder="Enter First Name" name="firstName" required /> <label><b>Last
										Name</b></label> <input class="w3-input w3-border" type="text"
									placeholder="Enter Last Name" name="lastName" required /> <label><b>Phone</b></label>
								<input class="w3-input w3-border" type="text"
									placeholder="Enter (555)555-5555" name="phone" required /> <label><b>Street</b></label>
								<input class="w3-input w3-border" type="text"
									placeholder="Enter Street" name="street" required /> <label><b>City</b></label>
								<input class="w3-input w3-border" type="text"
									placeholder="Enter City" name="city" required /> <label><b>State</b></label>
								<input class="w3-input w3-border" type="text"
									placeholder="Enter State" name="state" required /> <label><b>Zip</b></label>
								<input class="w3-input w3-border" type="text"
									placeholder="Enter Zip" name="zipCode" required />
				...
				<button
					...
					class="w3-bar-item w3-button">LOGIN</button>
			...
			<div class="w3-modal-content w3-card-4 w3-animate-zoom"
				...
				<div class="w3-center">
					<br /> <span
						...
						class="w3-button w3-xlarge w3-white w3-display-topright"
						title="Close Modal">x</span> <img src="img/profilePicDefault.png"
				...
				<form class="w3-container" action="registration.do">
					<div class="w3-section">
						...
						<label><b>Password</b></label> <input class="w3-input w3-border"
							type="text" placeholder="Enter Password" name="password" required />
						<label><b>Email</b></label> <input class="w3-input w3-border"
							type="text" placeholder="Enter Email" name="email" required /> <label><b>First
								Name</b></label> <input class="w3-input w3-border" type="text"
							placeholder="Enter First Name" name="firstName" required /> <label><b>Last
								Name</b></label> <input class="w3-input w3-border" type="text"
							placeholder="Enter Last Name" name="lastName" required /> <label><b>Phone</b></label>
